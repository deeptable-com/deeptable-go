...
func TestUserAgentHeader(t *testing.T) {
	...
	_, _ = client.StructuredSheets.New(context.Background(), deeptable.StructuredSheetNewParams{
		FileID: "file_01h45ytscbebyvny4gc8cr8ma2",
	})
	if userAgent != fmt.Sprintf("DeepTable/Go %s", internal.PackageVersion) {
...
func TestRetryAfter(t *testing.T) {
	...
	_, err := client.StructuredSheets.New(context.Background(), deeptable.StructuredSheetNewParams{
		FileID: "file_01h45ytscbebyvny4gc8cr8ma2",
	})
	if err == nil {
...
func TestContextCancel(t *testing.T) {
	...
	cancel()
	_, err := client.StructuredSheets.New(cancelCtx, deeptable.StructuredSheetNewParams{
		FileID: "file_01h45ytscbebyvny4gc8cr8ma2",
	})
	if err == nil {
		t.Error("Expected there to be a cancel error")
...
func TestContextDeadline(t *testing.T) {
	...
	go func() {
		...
		_, err := client.StructuredSheets.New(deadlineCtx, deeptable.StructuredSheetNewParams{
			FileID: "file_01h45ytscbebyvny4gc8cr8ma2",
		})
		if err == nil {
