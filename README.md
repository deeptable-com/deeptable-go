...
<a href="https://pkg.go.dev/github.com/stainless-sdks/deeptable-go"><img src="https://pkg.go.dev/badge/github.com/stainless-sdks/deeptable-go.svg" alt="Go Reference"></a>

<!-- x-release-please-end -->

The DeepTable Go library provides convenient access to the [DeepTable REST API](https://docs.deeptable.com)
...
```go
import (
	"github.com/stainless-sdks/deeptable-go" // imported as deeptable
)
```
...
```sh
go get -u 'github.com/stainless-sdks/deeptable-go@v0.0.1'
```
...
The deeptable library uses the [`omitzero`](https://tip.golang.org/doc/go1.24#encodingjsonpkgencodingjson)
...
See the [full list of request options](https://pkg.go.dev/github.com/stainless-sdks/deeptable-go/option).
...
`*deeptable.Error`. This contains the `StatusCode`, `*http.Request`, and
...
We also provide a helper `deeptable.NewFile(reader io.Reader, filename string, contentType string)`
...
We are keen for your feedback; please open an [issue](https://www.github.com/stainless-sdks/deeptable-go/issues) with questions, bugs, or suggestions.
