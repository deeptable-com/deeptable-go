...
<a href="https://pkg.go.dev/github.com/deeptable-com/deeptable-go"><img src="https://pkg.go.dev/badge/github.com/deeptable-com/deeptable-go.svg" alt="Go Reference"></a>
...
```sh
go get -u 'github.com/deeptable-com/deeptable-go@v0.1.0-beta.2'
```
...
See the [full list of request options](https://pkg.go.dev/github.com/deeptable-com/deeptable-go/option).
...
We are keen for your feedback; please open an [issue](https://www.github.com/deeptable-com/deeptable-go/issues) with questions, bugs, or suggestions.
